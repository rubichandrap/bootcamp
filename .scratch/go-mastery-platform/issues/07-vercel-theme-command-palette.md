# 07 — Vercel-Style Light/Dark UI Polish & Command Palette (`Cmd+K`)

**What to build:** Full Vercel-inspired light/dark theme toggling, overall progress rings, active learning streak counter, and a `Cmd+K` command palette for instant navigation across modules and chapters.
