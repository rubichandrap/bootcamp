# 02 — Python `01-core-data-structures` Module

**What to build:** A learner can progress past Basics into the Core Data Structures Module — lists, dicts, sets, tuples, and comprehensions. Reading Chapters teach the concepts; Challenge Chapters verify idiomatic use against pytest suites; the Assessment integrates all of them and gates the next Module.
...
#67 — Python RCE plumbing + `00-basics` Module
